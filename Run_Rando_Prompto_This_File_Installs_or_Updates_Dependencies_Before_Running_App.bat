...
echo * Click the 'Shuffle List' button to randomize the list order/mix in your new additions (25 shuffles per click)
...
echo [33m- Update: 18 - 6/28/2024            [92m )__)  \  /  )__)  )__)  )(__ \  /   [31m )(_) )[92m)__) [34m\__ \[35m _)(_[36m( (_-.[33m )  (  [0m
echo.                                    [92m(____) (__) (____)(__)  (____)(__)   [31m(____/[92m(____)[34m(___/[35m(____)[36m\___/[33m(_)\_) [31m
echo.
echo                                  . . . SCROLL TO TOP TO READ INSTRUCTIONS! . . .[35m
echo.
